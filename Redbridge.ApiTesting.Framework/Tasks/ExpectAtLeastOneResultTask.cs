...
{
    public class ExpectAtLeastOneResultTask<TUserSession> : ThenStatementTask<TUserSession> where TUserSession : IUserSession<TUserSession>
    {
        public override string TaskName => "Expect at least one result";
        ...
        protected override Task OnExecuteAsync(ScenarioContext<TUserSession> context)
        {
            ...
            {
                throw new UnexpectedTestScenarioResultException("Expected at least one result item, but received zero items.");
            }
